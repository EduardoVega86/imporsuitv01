$(document).ready(function() {
    ...
    $("#f_resultado").load("../ajax/incrementa_liquidacioncompra.php");
    $("#resultados2").load("../ajax/carga_caja.php");
    $("#resultados3").load("../ajax/carga_resibido.php");
    $("#resultados4").load("../ajax/tipo_docliquidacion.php");
    $("#resultados5").load("../ajax/carga_num_trans.php");
    $("#datos_liqudiacion").load();
    $("#barcode").focus();
    load(1);
});
...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalLiquidacioncompra.php",
...
$("#barcode_form").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregarliquidacioncompra_tmp.php",
        data: parametros,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loader.gif"> Cargando...');
        },
        success: function(datos) {
            ...
            $("#id").focus();
            $("#barcode").val("");
            $("#f_resultado").load("../ajax/incrementa_liquidacioncompra.php"); //Actualizamos el numero de Factura
        }
    });
...
//cargar datos
$("#datos_liquidacion").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/guardar_liquidacioncompra.php",
        data: parametros,
        beforeSend: function(objeto) {
        ...
        success: function(datos) {
            ...
            $("#datos_liquidacion")[0].reset(); //Recet al formilario de el cliente
            $("#barcode_form")[0].reset(); // Recet al formulario de la fatura
            $("#resultados").load("../ajax/agregarliquidacioncompra_tmp.php"); // carga los datos nuevamente
            $("#f_resultado").load("../ajax/incrementa_liquidacioncompra.php"); // carga la caja de incrementar la factura
