		...
		function load(page) {
		    ...
		    $("#loader").fadeIn('slow');
		    $.ajax({
		        url: '../ajax/buscar_retencion.php?action=ajax&page=' + page + '&q=' + q,
		...
		function generarXML(id_factura) {
		    var mywindow = VentanaCentrada('../xml/documentos/generar_xmlretencion.php?id_factura=' + id_factura, 'Factura', '', '724', '568', 'true');
			
                /*setTimeout(function () {
                    window.location.href = "http://localhost/punto_venta/vistas/html/bitacora_ventas.php";
                }, 4000);*/
		}
