		...
		function load(page) {
		    ...
		    $("#loader").fadeIn('slow');
		    $.ajax({
		        url: '../ajax/buscar_pixel.php?action=ajax&page=' + page + '&q=' + q,
		...
		function obtener_datos(id) {
		    var texto = $("#nombre" + id).val();
                    var pixel = $("#pixel" + id).val();
