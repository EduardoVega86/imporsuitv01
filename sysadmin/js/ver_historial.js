...
// Esta función podría recuperar y mostrar la existencia actual del producto.
function actualizarExistenciaProducto() {
    var idProducto = $("#id_producto").val(); // Asegúrate de que este ID es correcto y el input tiene valor.
    
    $.ajax({
        url: "../ajax/obtener_existencia.php", // Este archivo debe devolver la existencia actual del producto.
        type: "POST",
        data: { id_producto: idProducto },
        success: function(response) {
            $("#existencia_producto").text(response);
        }
    });
}
