		...
		function load(page) {
		    ...
		    $("#loader").fadeIn('slow');
		    $.ajax({
		        url: '../ajax/buscar_debito20.php?action=ajax&page=' + page + '&q=' + q,
		...
		function generarXML(id_factura) {
			var mywindow = VentanaCentrada('../xml/documentos/generar_xmldebito20.php?id_factura=' + id_factura, 'Factura', '', '724', '568', 'true');
