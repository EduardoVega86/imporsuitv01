...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalRetencion20.php",
...
function agregar_detalle_retencion(id2) {
    ...
    var baseImponible = document.getElementById('baseImponible').value;
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalRetencion20.php",
        data: "&tipoImpuesto=" + tipoImpuesto + "&codRetencion=" + codRetencion + "&operacion=" + 2 + "&id2=" + id2 + "&porcentaje=" + porcentaje
         + "&baseImponible=" + baseImponible + "&fecha=" + fecha
        + "&total=" + total + "&documento=" + documento + "&tipoDoc=" + tipoDoc,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loader.gif"> Cargando...');
        },
        success: function(datos) {
...
$("#barcode_form").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregarretencion20_tmp.php",
        data: parametros,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loader.gif"> Cargando...');
        },
        success: function(datos) {
            ...
            $("#id").focus();
            $("#barcode").val("");
            $("#f_resultado").load("../ajax/incrementa_retencion.php"); //Actualizamos el numero de Factura
        }
    });
...
$("#datos_retencion20").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/guardar_retencion20.php",
        data: parametros,
        beforeSend: function(objeto) {
        ...
        success: function(datos) {
            ...
            $("#datos_retencion20")[0].reset(); //Recet al formilario de el cliente
            $("#barcode_form")[0].reset(); // Recet al formulario de la fatura
            $("#resultados").load("../ajax/agregarretencion20_tmp.php"); // carga los datos nuevamente
            $("#f_resultado").load("../ajax/incrementa_retencion.php"); // carga la caja de incrementar la factura
            $("#resultados2").load("../ajax/carga_caja.php"); // carga la caja total del dia
            $("#fechaEmision").val(""); // carga la caja total del dia
            $("#periodoFiscal").val(""); // carga la caja total del dia
            $("#barcode").focus();
            //load(1);
