...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalguia.php",
...
$("#barcode_form").submit(function(event) {
    ...
    $.ajax({
        ...
        success: function(datos) {
            ...
            $("#id").focus();
            $("#barcode").val("");
            $("#f_resultado").load("../ajax/incrementa_guia.php"); //Actualizamos el numero de Factura
        }
    });
...
$("#datos_guia").submit(function(event) {
    ...
    $("#ructransportista2").val($("#ructransportista").val());
    $("#placa2").val($("#placa").val());
    $("#fechainicio2").val($("#fechainicio").val());
    $("#fechafin2").val($("#fechafin").val());
    $("#direccionpartida2").val($("#direccionpartida").val());
    $("#translado2").val($("#translado").val());
    ...
    $.ajax({
        ...
        success: function(datos) {
            ...
            $("#datos_guia")[0].reset(); //Recet al formilario de el cliente
            $("#barcode_form")[0].reset(); // Recet al formulario de la fatura
            $("#resultados").load("../ajax/agregarguia_tmp.php"); // carga los datos nuevamente
            $("#f_resultado").load("../ajax/incrementa_guia.php"); // carga la caja de incrementar la factura
