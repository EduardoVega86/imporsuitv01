...
<page pageset='new' backtop='10mm' backbottom='10mm' backleft='20mm' backright='20mm' footer='page'>
    ...
    <table cellspacing="0" style="width: 100%; margin-top:140px; text-align: left; font-size: 11pt; border: 1px solid #0A122A;border-radius:5px 5px 5px 5px;padding: 10px;">
        <tr>
...
echo 'RUC/CI: '.$rw_cliente['fiscal_cliente'];
echo "<br>";
echo 'Nombre: '.$rw_cliente['nombre_cliente'];
echo "<br>";
echo 'Direccion: '. $rw_cliente['direccion_cliente'];
echo "<br> Teléfono: ";
...
?>
       ...
       <br>
        <table cellspacing="0" style="width: 100%;  text-align: left; font-size: 11pt; border: 1px solid #0A122A;border-radius:5px 5px 5px 5px;padding: 10px;">
        <tr>
...
?>
    ...
    <table cellspacing="0" style="width: 100%;  text-align: left; font-size: 11pt; border: 1px solid #0A122A;border-radius:5px 5px 5px 5px;padding: 10px;">
        <tr>
            ...
            <th style="width: 15%;text-align: right" class='midnight-blue'>Sub Total</th>
...
// control del impuesto por productos.
    ...
    $precio_venta_unitario=$row['precio_venta'];
  ...
  /*  if ($row['iva_producto'] == 1) {
    ...
    ?>
        ...
        <tr>
            ...
            <td class='<?php echo $clase; ?>' style="width: 15%; text-align: right"><?php echo $precio_venta_unitario; ?></td>
