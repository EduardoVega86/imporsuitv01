...
if ($count == 1) {
    ...
    $ruc_ci     = $rw_factura['fiscal_cliente'];
...
<?php include "encabezado_factura.php";?>
    <br>
    <table cellspacing="0" style="width: 50%; margin-top:140px; text-align: left; font-size: 11pt; border: 1px solid #0A122A;-moz-border-radius: 13px;-webkit-border-radius: 12px;padding: 10px;">
        <tr>
            <td style="width:50%;" class='midnight-blue'>FACTURAR</td>
        </tr>
        <tr>
            <td style="width:50%;" >
                <?php
...
echo "<br>";
echo 'Direcciòn: '.$direccion_cliente;
echo "<br> Teléfono: ";
...
?>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left;border: 1px solid #0A122A;-moz-border-radius: 13px;-webkit-border-radius: 12px;padding: 10px;">
        <tr>
            ...
            <th class='midnight-blue' style="width: 20%;text-align: right">SUBTOTAL</th>
...
// control del impuesto por productos.
  ...
  /*  if ($row['iva_producto'] == 1) {
    ...
    $precio_total_f = $final_items; //Precio total formateado
    $precio_total_r = str_replace(",", "", $precio_total_f); //Reemplazo las comas
    ...
    <tr>
        ...
        <td class='<?php echo $clase; ?>' style="width: 15%; text-align: right"><?php echo $simbolo_moneda . '' . number_format($precio_venta_unitario,2); ?></td>
        <td class='<?php echo $clase; ?>' style="width: 15%; text-align: right"><?php echo $simbolo_moneda . '' . number_format($precio_venta_desglosado,2); ?></td>
        <td class='<?php echo $clase; ?>' style="width: 15%; text-align: right"><?php echo $simbolo_moneda . '' . number_format($precio_total_f,2); ?></td>
...
$total_factura = $subtotal + $total_impuesto; //total factura
?>
<tr>
...
<tr>
    ...
    <td style="width: 15%; text-align: right;"> <?php echo number_format($total_impuesto, 2); ?></td>
</tr><tr>
