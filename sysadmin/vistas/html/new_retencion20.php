...
$query = $conexion->query("select * from retencion20");
$tipo  = array();
...
<div id="wrapper" class="forced enlarged"> <!-- DESACTIVA EL MENU -->
	...
	include "../modal/buscar_productos_retencion.php";
	...
	include "../modal/codigosRetencion.php";
    ?>
									<div class="row">
										<div class="col-lg-12">
											<div class="card-box">
												<div class="widget-chart">
													<form action="">
														<div class="form-group row">
															...
															<label for="condiciones" class="control-label">Periodo Fiscal:</label>
														...
														<div class="form-group row">
															...
															<div class="col-md-2">
                                                                <div class="btn-group">                                                                                                                     
																	...
																	<button type="button" accesskey="a" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#productosretencion">
										...
										<div class="col-lg-4">
											<div class="card-box">
												<div class="widget-chart">
													<form role="form" id="datos_retencion20">
														<div class="form-group row">
															...
															<div class="col-12">
																<div class="input-group">
																	...
																	<input id="periodoFiscal2" name="periodoFiscal2" type='hidden'>
																</div>
															</div>
														</div>
														<div class="row">
...
<script type="text/javascript" src="../../js/retencion20.js"></script>
<!-- ============================================================== -->
...
<script>
	...
	$('#codigo-retencion-table tbody').on('click', 'tr', function () {
        $("#codRetencion").val($(this).find(".codigo").html());
        $("#porcentaje").val(parseFloat($(this).find(".porcentaje").html()));
	...
	function calcularaValorTotal() {
        var baseImponible = parseFloat($("#baseImponible").val());
	...
	$("#nombre_cliente" ).on( "keydown", function( event ) {
		if (event.keyCode== $.ui.keyCode.LEFT || event.keyCode== $.ui.keyCode.RIGHT || event.keyCode== $.ui.keyCode.UP || event.keyCode== $.ui.keyCode.DOWN || event.keyCode== $.ui.keyCode.DELETE || event.keyCode== $.ui.keyCode.BACKSPACE )
		{
			$("#id_cliente" ).val("");
			$("#rnc" ).val("");
			$("#resultados4").load("../ajax/tipo_docretencion.php");
		}
...
<script>
  function getval(sel)
  {
    ...
    $("#outer_comprobante").load("../ajax/carga_correlativosretencion.php?id_comp="+sel.value);
