...
// Asegúrate de que el ID de la bodega ha sido recibido correctamente.
if ($id_bodega > 0) {
    $query = "SELECT * FROM bodega WHERE id = '$id_bodega'";
    $result = mysqli_query($conexion, $query);
    if ($row = mysqli_fetch_assoc($result)) {
        // Variables para precargar en el formulario
        $nombre = $row['nombre'];
        $provincia = $row['provincia'];
        $ciudad_entrega = $row['localidad'];
        $direccion_completa = $row['direccion'];
        $nombre_contacto = $row['responsable'];
        $telefono = $row['contacto'];
        $numero_casa = $row['num_casa'];
        $referencia = $row['referencia'];
        $longitud = $row['longitud'];
        $latitud = $row['latitud'];
    } else {
        $errors[] = "No se encontró la bodega.";
    }
} else {
    $errors[] = "ID de bodega no válido.";
}
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <form id="miFormulario">
                                <input type="hidden" id="provincia" name="provincia" value="<?php echo htmlspecialchars($provincia); ?>">
                                <input type="hidden" id="ciudadEntrega" name="ciudadEntrega" value="<?php echo htmlspecialchars($ciudad_entrega); ?>">
                                <!-- Otros elementos del formulario aquí -->
                            </form>
                            <form id="formularioDatos" method="post" action="../ajax/procesar_edicion_bodega.php">

                                <input type="hidden" name="id_bodega" value="<?php echo htmlspecialchars($id_bodega); ?>">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        ?>
                                        <br>
                                        <input id="nombre" name="nombre" class="form-control " type="text" placeholder="Nombre de la Bodega" value="<?php echo htmlspecialchars($nombre); ?>" required>
                                        <br>
                                        ...
                                        <div>
                                            ...
                                            <div id="div_ciudad" onclick="verify()">
                                                <select class="datos form-control" id="ciudad_entrega" name="ciudad_entrega" onchange="seleccionarProvincia()" required>
                                        ...
                                        <br>
                                        <input readonly id="direccion_completa" name="direccion_completa" class="form-control" type="text" placeholder="Ingresa una dirección" value="<?php echo htmlspecialchars($direccion_completa); ?>">

                                        <br>
                                        <input id="nombre_contacto" name="nombre_contacto" class="form-control " type="text" placeholder="Ingrese Contacto" value="<?php echo htmlspecialchars($nombre_contacto); ?>">
                                        <br>
                                        <input id="telefono" name="telefono" class="form-control " type="text" placeholder="Telefono de contacto" value="<?php echo htmlspecialchars($telefono); ?>">
                                        <br>
                                        <input id="numero_casa" name="numero_casa" class="form-control " type="text" placeholder="Numero de Casa" value="<?php echo htmlspecialchars($numero_casa); ?>">
                                        <br>
                                        <input id="referencia" name="referencia" class="form-control " type="text" placeholder="Ingrese referencia" value="<?php echo htmlspecialchars($referencia); ?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input readonly id="latitud" name="latitud" class="form-control" type="text" placeholder="Latitud" value="<?php echo htmlspecialchars($latitud); ?>">
                                            <input readonly id="longitud" name="longitud" class="form-control" type="text" placeholder="Longitud" value="<?php echo htmlspecialchars($longitud); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var ciudadEntrega = document.getElementById('ciudadEntrega').value;

        // Establecer la provincia seleccionada
        $('#provinica').val(provincia); // Método simplificado y recomendado para seleccionar

        // Establecer la ciudad seleccionada
        $('#ciudad_entrega').val(ciudadEntrega); // Método simplificado y recomendado para seleccionar
    });
