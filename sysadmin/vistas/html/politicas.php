...
if ($permisos_editar == 1) {
        include '../modal/registro_politica.php';
        include "../modal/editar_politica.php";
        include "../modal/eliminar_politica.php";
...
?>
	...
	<!-- ============================================================== -->
	<script type="text/javascript" src="../../js/politicas.js"></script>
	<script>
