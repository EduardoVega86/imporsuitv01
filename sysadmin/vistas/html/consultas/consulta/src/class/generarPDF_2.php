...
//$pdf->Cell(40, 10, 'Hello World!');
        ...
        $pdf->SetFont('Arial', 'B', 8);
        $pdf->SetXY(10, 20);
        $pdf->MultiCell(100, 10, utf8_decode($document->infoTributaria->razonSocial), 0);
        $pdf->SetFont('Arial', '', 8);
        $pdf->SetXY(10, 25);
