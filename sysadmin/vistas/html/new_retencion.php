										...
										<div class="col-lg-12">
											<div class="card-box">
												<div class="widget-chart">
													<form id="form_debito" method="post" action="../ajax/guardar_retencion.php">
														<div class="form-group row">
															<label for="fecha" class="col-md-2 control-label">Fecha Emisi&oacute;n:</label>
															<div class="col-md-3">
															...
															<label for="condiciones" class="control-label">periodoFiscal:</label>
															<div class="col-md-3" align="left">
																	<input type="text" class="form-control" id="periodoFiscal" name="periodoFiscal" required="required" autocomplete="on" placeholder="##/##"/>
																	...
																	<div class="table-responsive">
																		<table class="table table-sm" id="detalles">
																			...
																			<tbody>
																				...
																				<!--<tr>
																					<td class="text-right" colspan="7">SubTotal Sin Impuesto</td>
...
<script>
	...
	$("#nuevoDetalle").click(function() {
        ...
        $('#detalles tbody tr:first').before("<tr>"
												+"<td><select name = 'tipoImpuesto[" + count + "]' id='tipoImpuesto" + count + "' class='form-cotrol'><option value = '1'> Renta</option><option value = '2'> IVA</option><option value = '6'> ISD</option></select></td>"
												+ "<td><input size = '8' type = 'text' readonly name = 'codRetencion[" + count + "]' class = 'valor form-cotrol' id = 'codRetencion" + count + "' required='required'/><button type='button' data-toggle='modal' data-target='#codigo-retencion' onclick = 'seleccionarFilaCodigoRetencion(" + count + ")'><i class='fa fa-search'></i></button></td>"
												+ "<td><input size = '4' type = 'text' readonly name = 'porcentaje[" + count + "]' class = 'valor form-cotrol' id = 'porcentaje" + count + "' onchange = 'calcularaValorTotal(" + count + ")' required='required'/></td>"
												+ "<td><input size = '6' type = 'text' name = 'baseImponible[" + count + "]' class = 'valor form-cotrol' id = 'baseImponible" + count + "' onchange = 'calcularaValorTotal(" + count + ")' required='required'/></td>"
												+ "<td><input size = '6' type = 'text' readonly name = 'total[" + count + "]' class = 'valor form-cotrol' id = 'total" + count + "'  required='required'/></td>"
												+ "<td><input type = 'text' name = 'documento[" + count + "]' class = 'valor form-cotrol' id = 'documento" + count + "' required='required'/></td>"
												+ "<td><select name = 'tipoDoc[" + count + "]' class='form-cotrol'><option value = '01'> Factura</option></select></td>"
												+ "<td><input size = '8' type = 'date' name = 'fecha[" + count + "]' class = 'valor form-cotrol' id = 'fecha" + count + "' required='required'/></td>"
