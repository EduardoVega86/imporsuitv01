...
$query = $conexion->query("select * from notacredito");
$tipo  = array();
											...
											<div class="card-box">
												<div class="widget-chart">
													<form action="">
														<div class="form-group row">
															...
															<div class="col-md-3" align="left">
																<div class="input-group">
																	<select class="form-control"  name="tipoDocumentocredito" id="tipoDocumentocredito" required="required">
														...
														<div class="form-group row">
															<label for="fecha" class="col-md-2 control-label">Nro Comprobante:</label>
															<div class="col-md-2">
																<input type="text" id="numeroDocMod" class="form-control" name="numeroDocMod" required="true" placeholder="###-###-#########">
																<!--<input type="text" class="form-control" id="barcode_qty" value="1" autocomplete="off">-->
															</div>
															<label for="condiciones" class="control-label">Motivo:</label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select id = "id_comp" class = "form-control" name = "id_comp" required autocomplete="off" onchange="getval(this);">
																		...
																		<?php endforeach;*/?>
																		<option value="1">NOTA CR&Eacute;DITO</option>
																	</select>
																</div>
															</div>
                                                                                                                    <div class="col-md-6">
...
<script>
	...
	$("#nombre_cliente" ).on( "keydown", function( event ) {
		if (event.keyCode== $.ui.keyCode.LEFT || event.keyCode== $.ui.keyCode.RIGHT || event.keyCode== $.ui.keyCode.UP || event.keyCode== $.ui.keyCode.DOWN || event.keyCode== $.ui.keyCode.DELETE || event.keyCode== $.ui.keyCode.BACKSPACE )
		{
			$("#id_cliente" ).val("");
			$("#rnc" ).val("");
			$("#resultados4").load("../ajax/tipo_doccredito.php");
		}
...
<script>
  function getval(sel)
  {
    ...
    $("#outer_comprobante").load("../ajax/carga_correlativoscredito.php?id_comp="+sel.value);
