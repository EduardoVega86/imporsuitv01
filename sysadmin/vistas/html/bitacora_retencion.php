									...
									<div class="form-group row">
										<div class="col-md-6">
											<div class="input-group">
												<input type="text" class="form-control" id="q" placeholder="Nombre del cliente o # debito" onkeyup='load(1);'>
...
?>
	...
	<script type="text/javascript" src="../../js/bitacora_retencion.js"></script>
