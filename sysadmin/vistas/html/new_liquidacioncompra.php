...
$query = $conexion->query("select * from liquidacioncompra");
$tipo  = array();
						...
						<div class="portlet">
							<div class="portlet-heading bg-primary">
								<h3 class="portlet-title">
									Nueva Liquidaci&oacute;n Compra
								</h3>
    ...
    ?>
									<div class="row">
												...
												<div class="widget-chart">
													<form action="">
														<div class="form-group row">
															<label for="fechaEmision" class="col-md-2 control-label">Fecha Emisi&oacute;n:</label>
															<div class="col-md-2">
										...
										<div class="col-lg-4">
											<div class="card-box">
												<div class="widget-chart">
													<form role="form" id="datos_liquidacion">
														<div class="form-group row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select id = "id_comp" class = "form-control" name = "id_comp" required autocomplete="off" onchange="getval(this);">
																		...
																		<?php endforeach;*/?>
																		<option value="1">LIQUIDACI&Oacute;N COMPRA</option>
																	</select>
																</div>
															</div>
                                                                                                                    <div class="col-md-6">
...
<script type="text/javascript" src="../../js/liquidacioncompra.js"></script>
<!-- ============================================================== -->
...
<script>
  function getval(sel)
  {
    ...
    $("#outer_comprobante").load("../ajax/carga_correlativosliquidacion.php?id_comp="+sel.value);
