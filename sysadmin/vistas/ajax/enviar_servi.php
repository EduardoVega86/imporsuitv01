...
$destino_url = "https://guias.imporsuit.com/Servientrega/Guia/" . $ultimoid;
...
if ($response) {
    ...
    if (isset($guia)) {
        ...
        VALUES (  '$server_url', '$ultimoid', '$guia', '$date_added', '', '$tienda','$url','$id_pedido_cot',"
            ...
            . "'0','$observacion','$costo_total',100, 3)";
...
*/
        ...
        if ($tipo_origen == 1) {
            ...
            $sql = "UPDATE facturas_cot SET  estado_factura=2, `guia_enviada`=1, `transporte`='SERVIENTREGA', `estado_guia_sistema`= 100
