...
if (empty($_POST['nombre'])) {
    ...
    $linea_padre      = intval($_POST['linea_padre']);
    ...
    if ($query_check_user == true) {
       ...
       $sql = "INSERT INTO lineas (nombre_linea, descripcion_linea, estado_linea, date_added, online, tipo, padre)
        VALUES ('$nombre','$descripcion','$estado','$date_added', $online, $tipo , $linea_padre)";
