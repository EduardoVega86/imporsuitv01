        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody id="resultados">
                    ...
                    <?php
                    $query_sql = "SELECT * FROM $sTable where cabecera_cuenta_cobrar.tienda = '$dominio_completo' AND cabecera_cuenta_cobrar.numero_factura=facturas_cot.numero_factura  LIMIT $offset,$per_page";
