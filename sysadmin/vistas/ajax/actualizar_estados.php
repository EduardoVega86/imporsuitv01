                        ...
                        <td align="center"><?php
                                            ...
                                            if ($response === false) {
                                                ...
                                                if ($data !== null && isset($data['estadoActualCodigo'])) {
                                                    ...
                                                    $conexion_destino = mysqli_connect('localhost', $marketplace, $marketplace, $marketplace);
                                                    $sql = "UPDATE `guia_laar` SET `estado_guia`='" . $data['estadoActualCodigo'] . "' WHERE `guia_laar`='" . $guia_numero . "'";
