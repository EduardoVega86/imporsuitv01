...
if (!empty($id) and !empty($cantidad)) {
    ...
    $comprobar = mysqli_query($conexion, "select * from tmp_notacredito, productos where productos.id_producto = tmp_notacredito.id_producto and  tmp_notacredito.id_producto='" . $id_producto . "' and session_id='" . $session_id . "'");
    ...
    if ($row = mysqli_fetch_array($comprobar)) {
        ...
        if ($cant > $row['stock_producto'] and $inv == 0) {
            ...
            $sql          = "UPDATE tmp_notacredito SET cantidad_tmp='" . $cant . "' WHERE id_producto='" . $id_producto . "' and session_id='" . $session_id . "'";
        ...
        $('#resultados').load('../ajax/agregar_tmp.php');
            ...
            $insert_tmp = mysqli_query($conexion, "INSERT INTO tmp_notacredito (id_producto,cantidad_tmp,precio_tmp,desc_tmp,session_id) VALUES ('$id_producto','$cantidad','$precio_venta','0','$session_id')");
        }
        // fin codicion cantaidad
    }
...
if (isset($_GET['id'])) //codigo elimina un elemento del array
{
    ...
    $delete = mysqli_query($conexion, "DELETE FROM tmp_notacredito WHERE id_tmp='" . $id_tmp . "'");
}
    ...
    <table class="table table-sm">
        <thead class="thead-default">
            <tr>
                ...
                <th class='text-center hidden'>COD</th>
                <th class='text-center hidden''>CANT.</th>
