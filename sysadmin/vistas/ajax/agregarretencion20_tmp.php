...
if (!empty($id) and !empty($id2) and !empty($cantidad) ) {
    var_dump('entra');die;
    $id_producto  = get_row('retencion20', 'id_factura', 'codigo_producto', $id2);
    $precio_venta = get_row('retencion20', 'valor1_producto', 'id_factura', $id_producto);
    ...
    $comprobar = mysqli_query($conexion, "select * from tmp_retencion20, notadebito20 where notadebito20.id_factura = tmp_notadebito20.id_debito and  tmp_notadebito20.id_debito='" . $id_producto . "' and session_id='" . $session_id . "'");
