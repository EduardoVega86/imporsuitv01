...
$image_name    = time() . "_" . basename($_FILES["imagefile_a4"]["name"]);
$target_file   = $target_dir . $image_name;
$imageFileType = pathinfo($target_file, PATHINFO_EXTENSION);
$imageFileZise = $_FILES["imagefile_a4"]["size"];
...
//1048576 byte=1MB
    ...
    /* Fin Validacion*/
    if ($imageFileZise > 0) {
        move_uploaded_file($_FILES["imagefile_a4"]["tmp_name"], $target_file);
        $imagen     = basename($_FILES["imagefile_a4"]["name"]);
        $img_update = "url_a4='../../img/productos/$image_name' ";
