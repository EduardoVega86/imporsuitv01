...
if ($action == 'ajax' and $server_url == "https://marketplace.imporsuit.com" || $server_url == "http://localhost" || $server_url == "https://einzas2.imporsuit.com") {
            ...
            <table class="table table-sm table-striped align-middle">
                ...
                ?>
                    ...
                    <tr class="align-middle">
                        <td class="align-middle"><input onchange="checkall()" type="checkbox" name="item" id="<?php echo $id_factura; ?>"></td>
                                                                                            ...
                                                                                            switch ($drogshipin) {
                                                                                                case 0:
                                                                                                    if ($guia_enviada == 1) {
                                                                                                        ...
                                                                                                        $guia_numero = ''; // Puedes omitir esta l铆nea si no necesitas asignar un valor espec铆fico
                                                                                                        $url = ''; // O asignar un valor espec铆fico para el caso sin gu铆a
                                                                                                    }
