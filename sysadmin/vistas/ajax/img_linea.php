...
if (isset($_REQUEST['id_producto'])) {
    $id_producto = intval($_REQUEST['id_producto']);
     //echo $sql_img;
    $sql_img     = mysqli_query($conexion, "select * from lineas where id_linea='$id_producto'");
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="file" class='form-control' name="imagefile_mod" id="imagefile_mod" onchange="upload_image_mod_linea(<?php echo $id_producto; ?>);">
				</div>
			</div>
		</div>
		<div class="row">
