...
if (!empty($id) and !empty($cantidad)) {
    ...
    $comprobar = mysqli_query($conexion, "select * from tmp_liquidacioncompra, productos where productos.id_producto = tmp_liquidacioncompra.id_producto and  tmp_liquidacioncompra.id_producto='" . $id_producto . "' and session_id='" . $session_id . "'");
    ...
    if ($row = mysqli_fetch_array($comprobar)) {
        ...
        if ($cant > $row['stock_producto'] and $inv == 0) {
            ...
            $sql          = "UPDATE tmp_liquidacioncompra SET cantidad_tmp='" . $cant . "' WHERE id_producto='" . $id_producto . "' and session_id='" . $session_id . "'";
        ...
        if ($cantidad > $stock and $inv == 0) {
            ...
            $insert_tmp = mysqli_query($conexion, "INSERT INTO tmp_liquidacioncompra (id_producto,cantidad_tmp,precio_tmp,desc_tmp,session_id) VALUES ('$id_producto','$cantidad','$precio_venta','0','$session_id')");
        }
        // fin codicion cantaidad
    }
