...
if (!empty($id) and !empty($id2) and !empty($precio_venta)) {
    ...
    $comprobar = mysqli_query($conexion, "select * from tmp_notadebito20, notadebito20 where notadebito20.id_factura = tmp_notadebito20.id_debito and tmp_notadebito20.id_debito='" . $id2 . "' and tmp_notadebito20.session_id='" . $session_id . "'");
    ...
    if ($row = mysqli_fetch_array($comprobar)) {
        ...
        /*if ($cant > $row['stock_producto'] and $inv == 0) {
            ...
            $sql          = "UPDATE tmp_notadebito20 SET precio_tmp='" . $precio_venta . "' WHERE id_debito='" . $id . "' and session_id='" . $session_id . "'";
        ...
        /*if ($cantidad > $stock and $inv == 0) {
            ...
            $insert_tmp = mysqli_query($conexion, "INSERT INTO tmp_notadebito20 (id_producto,id_debito,cantidad_tmp,precio_tmp,descripcion_tmp,desc_tmp,session_id) VALUES ('$id','$id2','$cantidad','$precio_venta','$descripcion_libre','0','$session_id')");
            echo "<script> $.Notification.notify('success','bottom center','NOTIFICACIÓN', 'DETALLE AGREGADO A LA NOTA CREDITO CORRECTAMENTE')</script>";
        //}
        // fin codicion cantaidad
    }
    ...
    echo "<script> $.Notification.notify('error','bottom center','NOTIFICACIÓN', 'Campos Vacios en Razon Modificacion y/o Valor Modificacion')</script>";
}
        ...
        <td class='text-center'>
            <div class="input-group">
                <select id="<?php echo $id_tmp; ?>" class="form-control employee_id">
                    ...
                    <?php /*
$sql1 = mysqli_query($conexion, "select * from tmp_notadebito20 where id_debito='" . $id_debito . "'");
