...
if (empty($_POST['abono'])) {
    ...
    $saldo_credi = $rw['saldo_credito'];
    $saldoTotal= $saldo_credi-$abono;
  ...
  VALUES ('$numero_factura', '$fecha', '$id_cliente', '$monto_credito', '$abono', '$saldo', '$user_id','1','$concepto');";
    ...
    $update_saldo = mysqli_query($conexion, "update creditos set saldo_credito='$saldoTotal' where numero_factura='$numero_factura'");
