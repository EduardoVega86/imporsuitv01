...
if (isset($conexion)) {
?>
    <form class="form-horizontal" method="post" name="saldar_abono" id="saldar_abono" enctype="multipart/form-data">
        <!-- Modal -->
        <div id="saldar-stock" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"> <i class="fa fa-edit"></i> Saldar Deuda</h4>
                    </div>
