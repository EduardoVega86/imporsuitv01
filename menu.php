  ...
  <strong style="font-size: 9px">   ❗ Alta Demanda de Pedidos - Realiza el Tuyo Antes Que Se Agoten</strong>
                ...
                <div>
                    ...
                    <?php  if(get_row('perfil', 'facebook', 'id_perfil', '1')) {
                            ?>
                    <a class="text-light" href="<?php if(get_row('perfil', 'facebook', 'id_perfil', '1')){ echo get_row('perfil', 'facebook', 'id_perfil', '1'); }?>" target="_blank" rel="sponsored"><i class="fab fa-facebook-f fa-sm fa-fw me-2"></i></a>
                    <?php  }
                            ?>
                      <?php  if(get_row('perfil', 'instagram', 'id_perfil', '1')) {
                            ?>
                    <a class="text-light" href="<?php if(get_row('perfil', 'instagram', 'id_perfil', '1')){ echo get_row('perfil', 'instagram', 'id_perfil', '1'); }?>" target="_blank"><i class="fab fa-instagram fa-sm fa-fw me-2"></i></a>
                    <?php  }
                            ?>
                    <?php  if(get_row('perfil', 'tiktok', 'id_perfil', '1')) {
                            ?>
                    <a class="text-light" href="<?php if(get_row('perfil', 'tiktok', 'id_perfil', '1')){ echo get_row('perfil', 'instagram', 'id_perfil', '1'); }?>" target="_blank"><i class="fab fa-tiktok fa-sm fa-fw me-2"></i></a>
                     <?php  }
                            ?>
