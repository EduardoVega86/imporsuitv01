...
<style>
        ...
        .social-icons li {
            ...
            margin-right: 20px; /* Espaciado entre íconos de redes sociales */
        }

        .social-icons a {
            color: <?php echo get_row('perfil', 'texto_footer', 'id_perfil', 1);?>; /* Color del icono de la red social */
            font-size: 24px;
...
<footer class="texto_footer footer color-accent-1 gradient section-sections--20805847089433__footer-padding"><div class="footer__content-top page-width"><div class="footer__blocks-wrapper grid"><div
                class="footer-block grid__item footer-block--desktop-3 footer-block--mobile-2"        
              >
                <h2 class="footer-block__heading texto_footer">Contacto:</h2>
               <div class="footer-block__details-content rte">
                      <p><?php echo get_row('perfil', 'texto_contactos', 'id_perfil', '1')?> </p><p><?php echo get_row('perfil', 'direccion', 'id_perfil', '1')?></p>
                    </div>
